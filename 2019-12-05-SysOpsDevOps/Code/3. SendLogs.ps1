...
$writeToLogAnalyticsSplat = @{
    ALWorkspaceID       = 'c7eae394-9ff8-4a8a-b866-2bbccd85e0a4'
    ...
    WorkspacePrimaryKey = 'eNsD1mOYeTTY8MP7JtEKWaJ4RcC4/evnthio0nQiuchUvZwxQXhnafZFNoAKlOPeWpEixCa7bOoYmh2wHMqYUA=='
}
